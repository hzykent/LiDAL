...
#Classes relabelled {255,0,1,...,18}.
#Predictions will all be in the set {0,1,...,18}
...
def confusion_matrix(pred_ids, gt_ids):
    ...
    return np.bincount(pred_ids[idxs] * 19 + gt_ids[idxs], minlength=361).reshape((19, 19)).astype(np.int32)
...
def evaluate(pred_ids=None, gt_ids=None, confusion=None):
    ...
    for i in range(N_CLASSES):
        ...
        mean_iou += class_ious[label_name][0] / 19
